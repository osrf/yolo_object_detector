...
void update_deconvolutional_layer_gpu(deconvolutional_layer layer, int batch, float learning_rate, float momentum, float decay);
...
void update_deconvolutional_layer(deconvolutional_layer layer, int batch, float learning_rate, float momentum, float decay);
