...
char *voc_names[] = {"coke", "gatorade"};
// char *voc_names[] = {"stopsign", "yieldsign"};

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/rohit/workspace/src/dn_object_detect/data/trainCG_list.txt";
    char *backup_directory = "/home/rohit/workspace/src/dn_object_detect/CG_dataset/";
    srand(time(0));
